...
def confirm_window():
    ...
    [sg.Text('_'  * 80)],
    [sg.Text("Insert identification document page")],
    [sg.Text("Do you have a clear image of your identification document",justification= "centre")],
...
def selected_testimage():
    sg.theme('LightBlue4')
    layout_column= [
    [sg.Text("Chosen Identification Image" ,justification="centre",size=(30, 1),font=("Helvetica", 25))],
    [sg.Text('_'  * 80)],
    [sg.Image(filename=r"testimage/viewtest.png", key="-IMAGETEST-")],
    [sg.Text("Choosen Image to be Used As Identification Document",justification = "centre")],
    [sg.Button("Continue ",size=(10, 3), key = "Continue")],
    [sg.Text('_'  * 100)],
    [sg.Text('_'  * 100)]
    ]
    ...
    window = sg.Window("Chosen Image page", layout, modal = True)
...
def select_testimage():
    sg.theme('LightBlue4')
    layout_column= [
    [sg.Text("Select Identification Image" ,justification="centre",size=(30, 1),font=("Helvetica", 25))],
    [sg.Text('_'  * 80)],
    [sg.Text("Choose Image to be Used As identification document ",justification = "centre")],
    ...
    window = sg.Window("Choose Identification document Page", layout, modal = True)
...
def prog_window():
    ...
    x=0
    layout_column= [
    [sg.Text("MS Face Matching ",size=(30, 1),font=("Helvetica", 25), key = "new")],
    [sg.Text('_'  * 80)],
