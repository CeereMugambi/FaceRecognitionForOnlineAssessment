...
for person in results:
    if len(person.candidates) > 0:
        ...
        sg.popup("MATCH FOUND PROCEED TO EXAMINATION!!")
        sp = subprocess.Popen( "cam.py", shell=True,
        ...
        sg.popup("MATCH NOT FOUND!!,KINDLY RESTART APPLICATION AND MAKE SURE YOU ARE IN A WELL LIT ROOM")